...
function onStepHit() 
	if curStep == 144 then movement = 20 m = {{-movement, 0}, {0, movement}, {0, -movement}, {movement, 0}} end 
	if curStep == 1840 then movement = 0 m = {{-movement, 0}, {0, movement}, {0, -movement}, {movement, 0}} end 
	if curStep == 1968 then movement = 15 m = {{-movement, 0}, {0, movement}, {0, -movement}, {movement, 0}} end 
end
